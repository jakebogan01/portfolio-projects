...
<button type="button" class="flex items-center justify-center text-white text-sm font-light {bkg} py-4 px-6 mt-6 w-full rounded">
    <slot name="btnIcon">
    ...
    <slot name="btnText">
        <span class="ml-2">Shop by category</span>
    </slot>
</button>
