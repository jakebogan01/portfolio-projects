<div class="hidden flex-1 lg:flex items-end justify-end">
    <div class="flex-1 max-w-[400px] relative pointer-events-auto">
        <button type="button" on:click class="w-full flex items-center text-sm leading-6 text-[#646769] bg-[#181A1B] rounded-md ring-1 ring-slate-900/10 py-3 pl-2 pr-3 hover:ring-slate-300">
